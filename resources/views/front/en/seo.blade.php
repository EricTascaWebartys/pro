					...
					<figure class="about__img-holder">
						<div class="animate">
							<div class="animate-container">
								<img src="{{ asset('img/about/seo.webp') }}" alt="responsive design">
						...
						<div class="animate">
							<div class="animate-container">
								<div class="title-row mb-40">
									...
									<h2 class="section-title">S.E.O</h2>
									<p class="section-description">
										The <strong class="no-strong">Search Engine Optimization</strong> can be defined as the art of positioning a site, a web page or an application in the first natural results of search engines. <br>
										A site coded from A to Z has the advantage of better referencing.
									</p>
								</div>
