						...
						<figure class="about__img-holder">
							<div class="animate">
								<div class="animate-container">
									<img src="{{ asset('img/about/pwa.jpg') }}" alt="pwa office">
							...
							<div class="animate">
								<div class="animate-container">
									<div class="title-row mb-40">
										...
										<h2 class="section-title">Smartphones & Tablettes</h2>
										<p class="section-description">Installer votre Application Web sur smartphones et tablettes</p>
									</div>
