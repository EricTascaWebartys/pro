            ...
            <div class="animate-container">
                <div class="team" style="padding:10px">
                    <a href="{{ route("description_2") }}">
                        <img src="{{ asset('img/design.jpg') }}" alt="design graphique" class="team__img bg-shadow-box" with="100%">
                    </a>
    ...
    <div class="col-lg-4">
        <div class="animate">
            <div class="animate-container">
                <div class="team" style="padding:10px">
                    <a href="{{ route("seo") }}">
                        <img src="{{ asset('img/seo.jpg') }}" alt="design graphique" class="team__img bg-shadow-box" with="100%">
                    </a>
            ...
            <div class="animate-container">
                <div class="team" style="padding:10px">
                    <a href="{{ route("description_3") }}">
                        <img src="{{ asset('img/pwa.jpg') }}" alt="design graphique" class="team__img bg-shadow-box" with="100%">
                    </a>
