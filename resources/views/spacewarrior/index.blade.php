...
<head>
  ...
  <title>shoot</title>
  <meta name="description" content="spacewarrior">
  <meta name="author" content="eric tasca">
...
<body>
    <div class="bg" id="gameScreen">
        <div onclick="openFullscreen();" class="fullScreen">

        </div>
        <div class="col-4 col-12 mx-auto cadre"  id="particles-js">
            <div id="sprite" class="sprite">
                <!-- <img src="img/spacecraft.png" alt="spacecraft"> -->
            </div>
            <div class="title-image">
                <img src="{{ asset('libs/spacewarrior/img/title.png') }}" alt="spacewarrior">
            ...
            <p class="life"><img src="{{ asset('libs/spacewarrior/img/spacecraft.png') }}" alt="life"> X <span id="life"></span></p>
    ...
    <script src="{{ asset('libs/spacewarrior/libs/particles.js-master/particles.js') }}"></script>
    <script src="{{ asset('libs/spacewarrior/libs/particles.js-master/demo/js/app.js') }}"></script>
    <script src="{{ asset('libs/spacewarrior/libs/particles.js-master/demo/js/lib/stats.js') }}"></script>

    <script type="text/javascript" src="{{ asset('libs/spacewarrior/js/class/Player.js') }}"></script>
    <script type="text/javascript" src="{{ asset('libs/spacewarrior/js/class/Enemy.js') }}"></script>
    <script type="text/javascript" src="{{ asset('libs/spacewarrior/js/class/Score.js') }}"></script>
    <script type="text/javascript" src="{{ asset('libs/spacewarrior/js/class/Keybord.js') }}"></script>
    <script type="text/javascript" src="{{ asset('libs/spacewarrior/js/class/Game.js') }}"></script>
    ...
    <script type="text/javascript">
        ...
        let game = new Game({
            ...
            url_classement:"{{ route('classement')}}",
            url_datas_save:"{{ route('datas_save')}}"
        });
...
let Music = {
    ...
    play: function(name){
        if(this.musics[name]){
            let url_music = "";
            if(this.musics[name] === "level_1") {
                url_music = '{{ asset("libs/spacewarrior/music/level_1.mp3") }}';
            } else if (this.musics[name] === "level_2") {
                url_music = '{{ asset("libs/spacewarrior/music/level_2.mp3") }}';
            } else if (this.musics[name] === "level_3"){
                url_music = '{{ asset("libs/spacewarrior/music/level_3.mp3") }}';
            } else if(this.musics[name] === "boss") {
                url_music = '{{ asset("libs/spacewarrior/music/boss.mp3") }}';
            } else if(this.musics[name] === "boss_fin") {
                url_music = '{{ asset("libs/spacewarrior/music/boss_fin.mp3") }}';
            }  else if(this.musics[name] === "stage_clear") {
                url_music = '{{ asset("libs/spacewarrior/music/stage_clear.mp3") }}';
            }  else if(this.musics[name] === "gameover") {
                url_music = '{{ asset("libs/spacewarrior/music/gameover.mp3") }}';
            } else if(this.musics[name] === "goat") {
                url_music = '{{ asset("libs/spacewarrior/music/goat.mp3") }}';
            }  else {
                url_music = '{{ asset("libs/spacewarrior/music/end.mp3") }}';
            }
            this.audio.src = url_music;
            this.audio.load();
...
let Sound = {
    ...
    play: function(name){
        if(this.musics[name]){
            let url_sound ="";
            if(this.musics[name] === 'laser_1') {
                url_sound = '{{ asset("libs/spacewarrior/music/laser_1.mp3") }}';
            } else {
                url_sound = '{{ asset("libs/spacewarrior/music/boss.mp3") }}';
            }
...
let Explosion = {
    ...
    play: function(name){
        if(this.musics[name]){
            let url_explo = "";
            if(this.musics[name] === 'explosion') {
                url_explo = '{{ asset("libs/spacewarrior/music/explosion.mp3") }}';

            } else if(this.musics[name] === 'explosion-boss') {
                url_explo = '{{ asset("libs/spacewarrior/music/explosion-boss.mp3") }}';
            } else {
                url_explo = '{{ asset("libs/spacewarrior/music/end.mp3") }}';
            }
            this.audio.src = url_explo;
            this.audio.load();
            this.audio.addEventListener('canplaythrough', function(){
                this.play();
            });
