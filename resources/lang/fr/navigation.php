...
return [
    ...
    */
    ...
    "Burundi" => "Burundi",
    "Call" => "Appeler",
    "Call Hotline" => "Appeler la hotline",
    "Call Us" => "Appeler-nous",
    "Cambodia" => "Cambodge",
    "Cameroon" => "Cameroun",
    "Canada" => "Canada",
    "Cancel" => "Annuler",
    ...
    "Comoros" => "Comores",
    "Company" => "Maison",
    "Company founded" => "Maison fondée",
    "Company Founded" => "Maison Fondée",
    "Company founded in" => "Maison fondée en",
    "Company Founded In" => "Maison Fondée En",
    "Conception / Creation" => "Conception / Création",
    "Confirm" => "Confirmer",
    ...
    "Denmark" => "Danemark",
    "Describe your project" => "Décrire votre projet",
    "Detach" => "Détacher",
    ...
    "Email" => "Email",
    "Dynamic Website" => "Site dynamique",
    ...
    "Original" => "Original",
    "Oops, something unexpected happened!" => "Oups, quelque chose d'imprévu s'est passé !",
    ...
    "Per Page" => "Par Page",
    "Perfect Coding" => "Conception de A à Z",
    ...
    "Request for quotation" => "Demander un devis",
    ...
    "They trusted us" => "Ils nous ont fait confiance",
