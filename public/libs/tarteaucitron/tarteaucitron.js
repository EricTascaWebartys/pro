          ...
          if(tarteaucitronCustomText !== ''){
            ...
            tarteaucitron.addInternalScript(pathToServices, '', function () {
                ...
                if (tarteaucitron.orientation === 'middle') {
                    ...
                    var customThemeMiddle = document.createElement('style'),
                        cssRuleMiddle = 'div#tarteaucitronRoot.tarteaucitronBeforeVisible:before {content: \'\';position: fixed;width: 100%;height: 100%;background: white;top: 0;left: 0;z-index: 999;opacity: 0.5;}div#tarteaucitronAlertBig:before {content: \'' + '' + '\';font-size: 35px;}body #tarteaucitronRoot div#tarteaucitronAlertBig {width: 100%;min-width: 285px;height: auto;margin: auto;left: 50%;top: 91%;transform: translate(-50%, -50%);box-shadow: 0 0 9000px #000;border-radius: 2px;padding: 35px 25px;}span#tarteaucitronDisclaimerAlert {padding: 0 30px;}#tarteaucitronRoot span#tarteaucitronDisclaimerAlert {margin: 10px 0 30px;display: block;text-align: center;font-size: 21px;}@media screen and (max-width: 900px) {div#tarteaucitronAlertBig button {margin: 0 auto 10px!important;}}@media screen and (max-width: 512px){body #tarteaucitronRoot div#tarteaucitronAlertBig{top:86%;}}@media screen and (max-width: 380px){body #tarteaucitronRoot div#tarteaucitronAlertBig{top:80%;height: 17rem;}}';
